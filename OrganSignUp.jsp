...
function sample6_execDaumPostcode() {
    ...
    function hospitalSignUpView() {
    	var hospitalView = document.getElementById("hospitalSignUp");
        ...
        <div class="container py-4">
            ...
            <div class="row align-items-center justify-content-between">
                <a class="navbar-brand h1 text-left">	
                    <span class="text-dark h4">기업</span> <span class="text-primary h4">회원가입</span>
                </a>
            </div>
            <form id="hospitalSignUp" method="get" action="PageControl.jsp" onsubmit="onSubmit()">
                <div class="form-group">
                       <label for="userId" class="form-label mt-4">아이디</label>
                    <input type="text" class="form-control" name="id" id="userId" aria-describedby="emailHelp" placeholder="아이디를 입력해주세요." required>
                ...
                <div class="form-group">
                       <label for="name" class="form-label mt-4">병원명</label>
                    <input type="text" class="form-control" id="name" aria-describedby="emailHelp" name="hospitalName" required>
                	<div class="valid-feedback">
                   ...
                   <div class="form-group">
                       <label for="hospitalNumber" class="form-label mt-4">대표전화</label>
                    <input type="text" class="form-control" id="hospitalNumber" aria-describedby="NumberHelp" name="hospitalNumber" placeholder="병원 대표 전화를 입력해주세요.">
                </div>      
                   <div class="form-group" style="margin-bottom: 20px;">
                       <label for="hospitalId" class="form-label mt-4">기관ID</label>
                    <input type="text" class="form-control" id="hospitalId" aria-describedby="hospitalIdHelp" name="hospitalId" placeholder="기관ID를 입력해주세요.">
                </div>      
           ...
           <div class="form-group">
                ...
                <input type=hidden name="hosAction" value="insert">
                <input type=hidden id = "hospitalAddress" name="hospitalAddress" value="">
            </form>
        </div>
    </section>
</body>
...
document.querySelector("#hospitalSignUp").addEventListener("submit", function(e){
   //만일 폼이 유효하지 않는다면 전송을 막아주기
   if(!isIdValid || !isRePwValid || !isPwValid || !isNameValid){
