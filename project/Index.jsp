	...
	<div class="container py-3">
		<div class="row">
			...
			window.onload = function() {
			  ...
			  const url = 'http://apis.data.go.kr/B551182/hospInfoServicev2/getHospBasisList?serviceKey=병원 정보 api%3Dpe=xml&pageNo=1&numOfRows=50';
			  ...
			  xhr.onreadystatechange = function () {
				if (xhr.readyState === 4 && xhr.status === 200) {
				  ...
				  for (let i = 0; i < items.length; i++) {
					...
					const dept = item.getElementsByTagName('clCd')[0]?.textContent || '-';
