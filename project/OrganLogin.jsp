...
<%
  	String check = (String)session.getAttribute("hosMemSave");
  	String id = (String)session.getAttribute("hosMemId");
	String pw = (String)session.getAttribute("hosMemPw");
...
<section class="container" style="max-width: 560px; padding-top: 20px; height: 500px;">
	...
	<form method="post" action="PageControl.jsp" style="padding-top: 30px;">
    	...
    	<div class="checkbox mb-3">
      		<label>	
        	<input type="checkbox" name="hosIdSave" value="c1" <%=checkStr %>> 로그인 정보 저장
      		</label>
    	</div>
    	<button class="w-100 btn btn-lg btn-primary" type="submit">로그인</button>
    	<input type=hidden name="hosAction" value="login">
	</form>
</section>
